        ...
        if ($azione === 'aggiungi') {
            $stmt = $db->prepare("
                ...
                (tipo, titolo, autore, anno_uscita, casa_editrice, lingua, genere, 
                 codice_dewey, collocazione, numero_armadio, numero_ripiano, numero_aula, isbn, numero_copie, copie_disponibili, trama, immagine_copertina)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            ");
            ...
            $stmt = $db->prepare("
                ...
                numero_ripiano = ?, numero_aula = ?, isbn = ?, numero_copie = ?, trama = ?, immagine_copertina = ?
                WHERE id = ?
            ");
